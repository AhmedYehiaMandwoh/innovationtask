    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="card p-2">
                    <form method="POST" action="{{ route('categories.update', [app()->getLocale(), $categorey->uuid]) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    name="title" id="title" value="{{ $categorey->title ?? '' }}">
                                @if (!$errors->has('title'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" dir="rtl"
                                    ...
                                    id="title_ar" value="{{ $categorey->title_ar ?? '' }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    value="{{ $categorey->image ?? ''}}" name="image"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control @error('alt') is-invalid @enderror"
                                    name="alt" id="alt" value="{{ $categorey->alt ?? '' }}">
                                @if (!$errors->has('alt'))
                                    <span class="invalid-feedback d-none" role="alert">
                                        <strong>{{ __('filedrequired') }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" dir="rtl"
                                    ...
                                    id="alt_ar" value="{{ $categorey->alt_ar ?? '' }}">
                        ...
                        <div class="modal-footer ">
                            <a href="{{route('categories.index', app()->getLocale())}}" class="btn btn-warning" >{{ __('Back') }}</a>
