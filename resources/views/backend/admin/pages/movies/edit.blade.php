    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="card p-2">
                    <form method="POST" action="{{ route('movies.update', [app()->getLocale(), $Movie->uuid]) }}"
                        ...
                        <div class="row">
                                    ...
                                    @forelse (categories() as $item)
                                        @if (app()->getLocale() == 'ar')
                                            <option value="{{ $item->id }}"
                                                @if ($Movie->cat_id == $item->id) selected @endif>{{ $item->title_ar }}
                                            </option>
                                        @else
                                            <option value="{{ $item->id }}"
                                                @if ($Movie->cat_id == $item->id) selected @endif>{{ $item->title }}
                                            </option>
                                        @endif
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                    name="slug" id="slug" value="{{ $Movie->slug ?? '' }}">
                                @if (!$errors->has('slug'))
                                    <span class="invalid-feedback d-none" role="alert">
                                        <strong>{{ __('filedrequired') }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" dir="rtl"
                                    ...
                                    id="slug_ar" value="{{ $Movie->slug_ar ?? '' }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" dir="rtl"
                                    ...
                                    id="title_ar" value="{{ $Movie->title_ar ?? '' }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('video_link') is-invalid @enderror"
                                    name="video_link" id="video_link" value="{{ $Movie->video_link ?? '' }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control meta_description @error('meta_description') is-invalid @enderror "
                                    name="meta_description" id="meta_description">{{ $Movie->meta_description ?? '' }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea dir="rtl" class="form-control meta_description_ar @error('meta_description_ar') is-invalid @enderror "
                                    name="meta_description_ar" id="meta_description_ar">{{ $Movie->meta_description_ar ?? '' }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-editor" >
                                    <textarea id="description" class="description @error('description') is-invalid @enderror" name="description">{{ $Movie->description ?? '' }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-editor" >
                                    <textarea id="description_ar" class="description_ar @error('description_ar') is-invalid @enderror" name="description_ar">{{ $Movie->description_ar ?? '' }}</textarea>
    ...
    <script>
        function getsubids() {
            $.ajax({
                type: "get",
                dataType: 'json',
                url: '{{ route('movies.mycity', app()->getLocale()) }}?id=' + $("#cat_id").val(),
